...
resource "aws_api_gateway_deployment" "learntrac_api" {
  rest_api_id = aws_api_gateway_rest_api.learntrac_api.id
  # stage_name removed - managed by aws_api_gateway_stage
...
resource "aws_api_gateway_resource" "auth" {
  rest_api_id = aws_api_gateway_rest_api.learntrac_api.id
  parent_id   = aws_api_gateway_rest_api.learntrac_api.root_resource_id
  path_part   = "auth"
}
...
output "api_gateway_url" {
  value       = "https://${aws_api_gateway_rest_api.learntrac_api.id}.execute-api.${var.aws_region}.amazonaws.com/${aws_api_gateway_stage.learntrac_stage.stage_name}"
  description = "API Gateway invoke URL"
}

output "api_gateway_id" {
  value       = aws_api_gateway_rest_api.learntrac_api.id
  description = "API Gateway REST API ID"
}

output "api_gateway_stage_name" {
  value       = aws_api_gateway_stage.learntrac_stage.stage_name
